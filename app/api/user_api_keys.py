...
log = logging.getLogger("pktnode.api.user_api_keys")
...
async def test_api_key(provider: str, body: ApiKeyIn, _: CurrentUser) -> dict:
    ...
    try:
        ...
        # httpx puts the full request URL in its exception text, and for a key
        # check that URL can contain the key being tested.
