...
----------------------
Background-threaded SQLite log handler for pktNode.
...
class SQLiteLogHandler(logging.Handler):
    ...
    def attach_to_root_logger(self, logger_name: str = "") -> None:
        ...
        # Ensure the target logger passes records at least at our level.
    ...
    def set_level(self, level: int) -> None:
        ...
        self.setLevel(level)
        # Also propagate upward so the attached logger doesn't filter early.
    ...
    def _drain(self) -> None:
        ...
        try:
            ...
            with con:
                ...
                # Trim to ring-buffer size: delete oldest rows beyond _MAX_ROWS.
                con.execute(
                    """
            ...
            # Never raise from a log handler — just print to stderr.
            import sys
