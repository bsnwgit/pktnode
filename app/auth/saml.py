"""
Okta SAML 2.0 SP helpers for pktNode.
Identical to pktFlow implementation — only default base_url differs.
"""
...
async def load_saml_settings(db) -> Optional[dict]:
    ...
    base_url     = _decode(kv, "base_url", "http://localhost:8767").rstrip("/")
